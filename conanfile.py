...
conan_basic_setup()''')
            ...
            tools.replace_in_file("cmake/libprotobuf.cmake", "DEBUG_POSTFIX \"${protobuf_DEBUG_POSTFIX}\"", "")
            tools.replace_in_file("cmake/libprotobuf-lite.cmake", "DEBUG_POSTFIX \"${protobuf_DEBUG_POSTFIX}\"", "")
            tools.replace_in_file("cmake/libprotoc.cmake", "DEBUG_POSTFIX \"${protobuf_DEBUG_POSTFIX}\"", "")
